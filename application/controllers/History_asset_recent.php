...
class History_asset_recent extends CI_Controller{
	...
	function index4()
    {
        ...
        $this->load->view('history_asset_recent/fetch');
	}
	...
	function index6()
    {
        $data['history_asset_recent'] = $this->History_asset_recent_model->get_all_history_asset_recent();
        //$data['_view'] = 'item_table/exporter';
        $this->load->view('history_asset_recent/ListStatus',$data);
	}
	...
	function index7()
    {
        $data['history_asset_recent'] = $this->History_asset_recent_model->get_all_history_asset_recent();
        //$data['_view'] = 'item_table/exporter';
        $this->load->view('history_asset_recent/notFound',$data);
    }
    ...
    function index8()
    {
        $data['history_asset_recent'] = $this->History_asset_recent_model->get_all_history_asset_recent();
        //$data['_view'] = 'item_table/exporter';
        $this->load->view('history_asset_recent/imageStatus',$data);
	}
