...
<body style="font-family: 'Sarabun', sans-serif;">
	...
	<a href="<?php echo base_url('index.php/history_asset_recent/index2/imgAsset') ?>" target="_blank" class="btn btn-info"><i
    ...
    <form action="<?php echo base_url('index.php/history_asset_recent/index4/fetch'); ?>" method="post">
