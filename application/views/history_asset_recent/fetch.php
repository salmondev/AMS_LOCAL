...
<body style="font-family: 'Sarabun', sans-serif;">
  ...
  <tbody>
   ...
   <!-- <a href="<?php echo site_url('history_asset_recent/index5/total_result') ?>" class="btn btn-primary">สรุปผลการตรวจสอบ</a>-->
    ...
    <button type="submit" class="btn btn-primary"><i class="fa fa-print" style="margin:5px" aria-hidden="true"></i>สรุปผลการตรวจสอบ</button>
    
    </form>
    </br>
    <button class="btn btn-danger" onclick="goBack()"><i class="fa fa-arrow-left" style="margin-right:5px"></i>BACK</button>
