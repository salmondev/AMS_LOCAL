...
<div class="container box">
	...
	<br />
	<form name="frmMain" action="<?php echo base_url('index.php/location/index4/printQRlocate') ?>" method="post"
	...
	<td>
		...
		<form action="<?php echo base_url('index.php/location/index3/genqrlocate') ?>" method="post" name="form1">
