...
$departmentidindex = array_search("DEPARTMENTID", $fieldnames);
   ...
   echo "<script>
   alert('Import Done');
   window.location.href='http://localhost/ams_pro/ams/index.php/refer/index/index';
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header">
						<div class="box-title">
							<a href="<?php echo site_url('refer/add'); ?>" class="btn btn-success btn-lg"><i
									class="fa fa-plus" style="margin:5px"></i>ADD REFER</a>
					...
					<div class="box-body">
						<table id="example2" class="table table-striped table-bordered">
							...
							<tr>
								...
								<td>
									<a href="<?php echo site_url('refer/edit/'.$R['REFERID']); ?>"
										class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit</a>
									<a href="<?php echo site_url('refer/remove/'.$R['REFERID']); ?>"
