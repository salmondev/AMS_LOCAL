...
if(isset($_POST['SetQRsize']))
        {
			$path = 'http://localhost/ams_pro/ams/docs/';
			...
			redirect('http://localhost/ams_pro/ams/index.php/asset/index3/sync');
		}
...
<div class="container box">
	<div id="divResult">
		...
		<div>
			...
			<label>ตั้งค่าขนาด QR Code เริ่มต้น <div style="color: red;">* เซนติเมตร</div></label></p>
				<input type="number" name="defQRsize" value=""  required maxlength="1" max="10" min="1"/>
	...
	-->
					...
					<tr>
						...
						<td>
							<input type="number" name="qrsize[]" id="qrsize<?php echo $i;?>" value="<?php readfile('http://localhost/ams_pro/ams/docs/SETqrSize_.txt'); ?>" placeholder="เซนติเมตร" max="6">
		</form>
		</td>
		<td>
